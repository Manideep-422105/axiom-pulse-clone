...
import {
  ...
  RiStarLine,
  RiArrowDownSLine,
  RiGlobalLine, // Added for mobile view
} from "react-icons/ri";
        ...
        <div className="flex flex-row gap-[16px] justify-start items-center">
          ...
          <div className="hidden sm:block">
            <div className="relative flex">
              ...
              >
                <img
                  src="https://cryptologos.cc/logos/solana-sol-logo.svg?v=025" // Use your local asset path
                  alt="Solana"
                  width="16"
                  height="16"
                />
