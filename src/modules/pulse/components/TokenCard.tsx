      ...
      <div className="flex flex-col items-center gap-[4px]">
        <div className="relative w-[74px] h-[74px] flex justify-center items-center">
          ...
          <div className="absolute top-0 left-0 w-[74px] h-[74px] z-10 flex items-center justify-center">
             <svg width="78" height="78" viewBox="0 0 78 78" className="rotate-[-90deg]">
                {/* Background Path */}
                <path 
        ...
        <div className="flex flex-row w-full h-[18px] gap-[12px] items-center">
           ...
           <div className="hidden xl:flex flex-row flex-1 h-[18px] gap-[10px] items-center justify-start">
              ...
              <div className="flex items-center gap-[2px]">
                 ...
                 <span className="text-[12px] font-medium text-white">{data.holders}</span>
              </div>
              
              {/* Top Traders */}
              <div className="flex items-center gap-[2px]">
                 {/* Using generic icon for 'icon-pro-trader' */}
                 <div className="w-[16px] h-[16px] bg-primaryStroke rounded flex items-center justify-center">T</div> 
...
function Badge({ badge }: { badge: TokenData['badges'][0] }) {
   ...
   const textColor = 
      badge.color === 'green' ? 'text-primaryGreen' : 
      badge.color === 'blue' ? 'text-primaryBlue' : 
      'text-textSecondary';
