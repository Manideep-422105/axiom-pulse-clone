...
const FooterLink = memo<FooterLinkProps>(({ icon, label, hasDot }) => (
...
const TickerItem = memo<TickerItemProps>(({ icon, label, color, hideOn }) => (
  <span className="contents">
    <button
      className={`${hideOn} ${color} flex flex-row flex-shrink-0 h-[24px] px-[0px] gap-[2px] justify-start items-center hover:brightness-110 transition-all duration-125 ease-in-out`}
    >
      <img
        alt="coin"
        width="16"
...
const IconButton = memo<IconButtonProps>(({ icon }) => (
  <span className="contents">
      ...
      <div className="flex flex-row w-full h-full px-[24px] justify-between items-center gap-[16px] overflow-hidden">
              ...
              <div className="w-full">
                <button className="group border border-primaryStroke flex flex-row h-[24px] pl-[8px] pr-[5px] gap-[6px] justify-start items-center rounded-full hover:bg-primaryStroke/60 transition-colors duration-125 cursor-pointer">
                  <div className="flex flex-row gap-[4px] justify-start items-center">
                    ...
                    <span className="text-[12px] font-medium text-textTertiary group-hover:text-textSecondary transition-colors duration-125">
                      1
                    </span>
                  </div>
                  <div className="flex flex-row gap-[4px] justify-start items-center">
            ...
            <button className="hidden lg:flex flex-row h-[24px] px-[0px] gap-[4px] justify-start items-center hover:brightness-110 transition-all duration-125">
              <div className="relative">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgb(83, 211, 142) 0%, rgb(231, 140, 25) 50%, rgb(75, 188, 207) 100%)",
                  }}
                ></div>
        ...
        <div className="flex flex-row items-center gap-[8px] flex-shrink-0 justify-end">
          ...
          <div className="text-textSecondary flex flex-row gap-[8px] justify-start items-center">
            ...
            <a
              href="#"
              className="hidden md:flex flex-row gap-[2px] h-[24px] px-[8px] justify-start items-center rounded-[4px] hover:bg-white/5"
            >
